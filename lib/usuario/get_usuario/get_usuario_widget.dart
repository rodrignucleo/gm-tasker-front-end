...
import 'get_usuario_model.dart';
export 'get_usuario_model.dart';

class GetUsuarioWidget extends StatefulWidget {
  const GetUsuarioWidget({Key? key}) : super(key: key);

  @override
  _GetUsuarioWidgetState createState() => _GetUsuarioWidgetState();
}

class _GetUsuarioWidgetState extends State<GetUsuarioWidget> {
  late GetUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetUsuarioModel());
