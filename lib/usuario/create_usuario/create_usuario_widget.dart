...
import 'create_usuario_model.dart';
export 'create_usuario_model.dart';

class CreateUsuarioWidget extends StatefulWidget {
  const CreateUsuarioWidget({Key? key}) : super(key: key);

  @override
  _CreateUsuarioWidgetState createState() => _CreateUsuarioWidgetState();
}

class _CreateUsuarioWidgetState extends State<CreateUsuarioWidget> {
  late CreateUsuarioModel _model;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: GMApiGroup.createUsuarioCall.call(),
                                    builder: (context, snapshot) {
                                      ...
                                      final buttonCreateUsuarioResponse =
                                          snapshot.data!;
                                      return FFButtonWidget(
                                        onPressed: () async {
                                          _model.createUser = await GMApiGroup
                                              .createUsuarioCall
                                              .call(
                                            nome: _model
