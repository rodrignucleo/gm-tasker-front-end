...
import 'create_requisicao_widget.dart' show CreateRequisicaoWidget;
...
class CreateRequisicaoModel extends FlutterFlowModel<CreateRequisicaoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Create Requisicao)] action in Button widget.
  ApiCallResponse? apiCreateUser;
