...
import 'get_requisicao_info_model.dart';
export 'get_requisicao_info_model.dart';

class GetRequisicaoInfoWidget extends StatefulWidget {
  const GetRequisicaoInfoWidget({
    Key? key,
    ...
    required this.responsavelRequisicao,
    required this.usuarioCadastro,
  }) : super(key: key);
  ...
  final String? responsavelRequisicao;
  final String? usuarioCadastro;

  @override
  _GetRequisicaoInfoWidgetState createState() =>
      _GetRequisicaoInfoWidgetState();
}

class _GetRequisicaoInfoWidgetState extends State<GetRequisicaoInfoWidget> {
  late GetRequisicaoInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetRequisicaoInfoModel());
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            keyboardType:
                                                TextInputType.datetime,
                                            validator: _model
                                                .dataCadastroControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.dataCadastroMask
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      if (widget.sprintRequisicao != 'null')
                                        Container(
                                          width: 327.0,
                                          height: 105.0,
                                          decoration: BoxDecoration(
